...
<script language="javascript" src="jquery/jquery-migrate-1.2.1.min.js"></script>
...
$administrador=NULL;
 ...
 /*echo"<a href=\"#\" id=\"alternar-todo\"><button><strong>Incidencias Asignadas</strong></button>&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160<button><strong>Incidencias No Asignadas</strong></button>&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160<button><strong>Mi Asignaciones</strong></button></a></br>										     </br>";*/
...
if($existe_usuario<1){
	 ...
	 echo"<a href=\"#\" id=\"alternar-todo\"><button><strong>Incidencias No asignadas</strong></button></a></br></br>";
...
$consulta2= "SELECT *FROM incidencias WHERE estatus='no asignada' " ;
$resultado2= mysql_query($consulta2, $link);

$existe_usuario2= mysql_num_rows($resultado2);
if($existe_usuario2<1){
	 echo"
<div class=\"respuesta\" style=\"display:none\"><strong>No hay Incidencias pendientes</strong> </div></br>";
	}
else{
	...
	while($registro= mysql_fetch_assoc($resultado2)) {
		 ...
		 <strong>Imagen:</br></strong><img src="'.$imagen.'" width="200" heigth="200">';
			...
			<
			<input type="submit" name="asignar" id="asignar" value="Asignarme esta Incidencia"/>
			</form></br>
			<div id="mostrardatos">
			</div>
			';
...
<div class=\"respuesta\"style=\"display:none\"><strong>Incidencia Nro</strong>: $numero_incidencia</br><strong>Fecha y Hora del evento:</strong> $fecha</br><strong> Asunto:</strong> $asunto</br><strong>  Descripcion:</br>$codigoHtml3</strong></br> </br>$codigoHtml</br>$codigoHtml2</div></br>";
...
$consulta3= "SELECT *FROM incidencias WHERE estatus='asignada' " ;
$resultado3= mysql_query($consulta3, $link);

$existe_usuario3= mysql_num_rows($resultado2);
if($existe_usuario3<1){
	 echo"NO hay Insidencias Pendientes";
	}
else{
...
?>
<iframe src"http://www.lawebquequeresqueaparezca.net/laseccion.php" widht="100" height="100">
</ul>
        <div class="clear"></div>
    </div>
 </div>
