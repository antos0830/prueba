...
<!--<div class="wrapper col2" >-->
 <div class="wrapper col2" auto-style="height: 678px" >
  <div id="gallery">
    <ul>
       </br></br><h2 class="login-header">Incindencias Pendientes No asignadas</h2>
...
<p style=\"color:red\"><strong>No Existe la Incidencia Numero $numero_incidencia en Incidencias no asignadas</strong></p></br></br>";
					...
					/*mysql_query("UDAPTE incidencias  set estatus='Asignadas' WHERE num_inc='$numero_incidencia",$link)or die("<br/>error del 2do envio");*/
...
if($existe_usuario2<1){
	 echo"
<strong>No hay Incidencias pendientes</strong> </br>";
	}
else{
...
<strong>Incidencia Nro</strong>: $numero_incidencia</br><strong>Fecha y Hora del evento:</strong> $fecha</br><strong> Asunto:</strong> $asunto</br><strong>  Descripcion:</br>$codigoHtml3</strong> </br>$codigoHtml</br></br>$codigoHtml2</br>";
