...
<div class="wrapper col2" style="height: 678px" >
  <div id="gallery">
    <ul>
     ...
     <h2 class="login-header">Estadistica de las Incindencia</h2>
     <div class="login-container" height="700">
     <center><table height="100" width="700" border="2px" > 
     <tr><td><form action"historialInsidencias.php"  method"post">
     <input type="submit" name="mostrar" value="Mostrar Todas las Insidencias"
     </form></td><td>
     
     <form action"historialInsidencias.php"  method"post">
     <input type="submit" name="mostrar" value="Mostrar Todos los Usuarios"
     </form></td></tr>
     
     <tr><td><form action"historialInsidencias.php"  method"post">
     <label for"Buscar por N# de Incidencia"><b>Buscar N# de Incidencia</b> </label>
     <input type="text" name="mostrar"  required />
     <input type="submit" name="mostrar" value="Mostrar"
     </form>
     
      </td><td><form action"historialInsidencias.php"  method"post">
     <label for"mostrar todos los Usuarios"><b>Incidencia de un Usuario</b> </label>
     <input type="text" name="mostrar"  required />
     <input type="submit" name="mostrar" value="Mostrar"
     </form></td></tr>
     
     <tr><td><form action"historialInsidencias.php"  method"post">
     <label for"Buscar por Tipo de Incidencias"><b>Buscar Tipo de Incidencias</b> </label>
     <input type="text" name="mostrar"  required />
     <input type="submit" name="mostrar" value="Mostrar"
     </form>
     ...
     <label for"mostrar todos los Usuarios"><b>Solucion de tipo de Incidencia</b></label>
     <input type="text" name="mostrar"  required />
     <input type="submit" name="mostrar" value="Mostrar"
     </form></td></tr>
     </table></center></div>
